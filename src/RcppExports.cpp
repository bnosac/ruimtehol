...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(textspace(model, trainFile, initModel, validationFile, testFile, basedoc, predictionFile, fileFormat, label, loss, similarity, lr, termLr, norm, margin, initRandSd, p, dropoutLHS, dropoutRHS, wordWeight, dim, epoch, ws, maxTrainTime, validationPatience, thread, maxNegSamples, negSearchLimit, minCount, minCountLabel, bucket, ngrams, trainMode, K, verbose, debug, adagrad, normalizeText, saveEveryEpoch, saveTempModel, shareEmb, useWeight, trainWord, excludeLHS));
    return rcpp_result_gen;
END_RCPP
}
...
Rcpp::List textspace_save_model(SEXP textspacemodel, std::string file);
RcppExport SEXP _ruimtehol_textspace_save_model(SEXP textspacemodelSEXP, SEXP fileSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type textspacemodel(textspacemodelSEXP);
    Rcpp::traits::input_parameter< std::string >::type file(fileSEXP);
    rcpp_result_gen = Rcpp::wrap(textspace_save_model(textspacemodel, file));
    return rcpp_result_gen;
END_RCPP
}
